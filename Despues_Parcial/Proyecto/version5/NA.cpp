            ...
            case 'c': //Create
            {
                ...
                switch(buff[0])
                {
                    case 'w': //word
                    {
                        ...
                        //para confirmar que si se agrego
                        cout<<"Se agrego un word: "<< string(campo) <<" - "<<string(data)<<endl;
                        
                        //mensaje de retorno-----------------
                        /*
                        string mensajeRetorno = "+word";
                        char userBuffSize[5];
                        ...
                        */
                        ...
                        //si quieres que envie algo descomentame
                    ...
                    case 'g': //Glosario
                    {
                        ...
                        //para que se vea que si se agrego
                        ...
                        */
                        ...
                        //si quieres que reenvie descomentame
                        //send(SocketFD, response.c_str(), response.length(),0);
            ...
            case 'r': //read
            {
                ...
                switch(buff[0])
                {
                    ...
                    case 'g': //leer un BD g
                    {
                        ...
                        cout<<"Buscare"<<endl;
                        if(BD_glosario.count(c) > 0)
                        {
                            cout<<"encontró "<<c<<endl;
                            resultados = BD_glosario[c];
                            //chancar el primer elemento del vector ya que sse mandará ese
